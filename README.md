...
<div align="center">
dgsfsfgbmsgmf;mbzdm;klmmc bzc bndzphzl n,m z bnknhkp gh  bn
...
JourneySync solves the chaos of group riding: scattered WhatsApp threads, no live map sync, lost riders, and zero safety net. Built end-to-end as a cross-platform mobile app with Gmail login, profile management, and Supabase-powered auth, data, and storage.
...
- 🔴 **SOS sharing & live ride lobby** — nearby ride alerts and real-time ride tracking
...
- Deep learning on mel-spectrograms achieves 92.23% AUC (95.5% sensitivity) for heart sound classification
- TensorFlow Lite optimization cuts model size by 91% (1.33MB → 0.12MB) for real-time mobile inference
- Streamlit + Gradio web interface with QR-based workflows and waveform/mel-spectrogram visualization for offline, mobile-first cardiac screening
...
| Repo | Description |
|---|---|
| [deep-learning](https://github.com/pranavv1210/deep-learning) | Step-by-step deep learning notebooks, examples, and end-to-end projects |
| [machine-learning](https://github.com/pranavv1210/machine-learning) | Beginner-friendly ML repo with notebooks, datasets, and projects |
| [scikit-learn](https://github.com/pranavv1210/scikit-learn) | scikit-learn practice notebooks organized by topic |
...
**Reach me:** [LinkedIn](https://www.linkedin.com/in/pranav-venu-550729264/) · [Portfolio](https://pranavportfolioweb.onrender.com/) · [YouTube](https://www.youtube.com/@pranavvenu) · [GitHub](https://github.com/pranavv1210)
